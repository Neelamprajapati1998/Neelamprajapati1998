...
$result = mysqli_query($conn, "UPDATE `employee` SET `firstName`='$firstname',`lastName`='$lastname',`email`='$email',`DOB`='$DOB',`gender`='$gender',`contact`='$contact',`nid`='$nid',`address`='$address',`dept`='$dept',`degree`='$degree' WHERE id=$id");
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="edit.php" method="POST">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="DOB" value="<?php echo $DOB;?>">
